...
## [v26.2.4-mc26.2.x] - 2026-09-14

### Added

- Add back updated `ClientInputEvents.MouseScroll`
- Add `AbstractAdvancementProvider$DisplayInfoBuilder`
...
- Invoke `ClientTagsUpdatedCallback` later during client setup

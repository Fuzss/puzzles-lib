...
public final class NeoForgeClientEventInvokers {
    ...
    public static void registerEventHandlers() {
        ...
        INSTANCE.register(SubmitNameTagCallback.class,
                RenderNameTagEvent.DoRender.class,
                (SubmitNameTagCallback callback, RenderNameTagEvent.DoRender event) -> {
                    EventResult eventResult = callback.onSubmitNameTag(event.getEntityRenderer(),
        ...
        INSTANCE.register(ClientPlayerNetworkEvents.Join.class,
                ...
                (ClientPlayerNetworkEvents.Join callback, ClientPlayerNetworkEvent.LoggingIn event) -> {
                    callback.onPlayerJoin(event.getPlayer(), event.getMultiPlayerGameMode(), event.getConnection());
                });
